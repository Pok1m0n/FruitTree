# 🍏 FruitTree - Easily Manage Your Tree Nodes
...
- **Cut, Copy, and Paste**: Use simple commands to rearrange your nodes.
- **Undo and Redo**: Change your mind? Just reverse your last action.
...
3. **Install FruitTree**:
   ...
   - For macOS: Open the downloaded `.dmg` file and drag FruitTree to your Applications folder.
   - For Linux: Follow your distribution’s method for running `.jar` files, usually through the terminal.

4. **Launch the Application**: After installation, find FruitTree on your desktop or in your applications menu and double-click to open it.

## 📂 How to Use FruitTree
1. **Creating a New Node**: Click the "New" button to create a new tree node.
2. **Renaming a Node**: Right-click on any node, select "Rename," and enter your desired name.
3. **Moving Nodes**: Click and drag a node to reposition it. Use Cut (Ctrl + X) and Paste (Ctrl + V) to move nodes to different locations.
